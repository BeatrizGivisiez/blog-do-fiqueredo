...
//       },
//       timestamp: '2019-02-23T07:48Z',
//       content: 'Ainda assim, existem dúvidas a respeito de como a execução dos pontos do programa representa uma abertura para a melhoria da gestão inovadora da qual fazemos parte. Não obstante, a crescente influência da mídia aponta para a melhoria das direções preferenciais no sentido do progresso.'
//     }
//   ]
// };
